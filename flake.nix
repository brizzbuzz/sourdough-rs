      ...
      let
        ...
        fileSetForCrate = crate: lib.fileset.toSource {
          ...
          fileset = lib.fileset.unions [
            ...
            ./Cargo.lock
            ./.sqlx
            (craneLib.fileset.commonCargoSources ./crates/database)
        ...
        checks = {
          ...
          my-workspace-hakari = craneLib.mkCargoDerivation {
            ...
            buildPhaseCargoCommand = ''
              cargo hakari generate --diff  # workspace_hack Cargo.toml is up-to-date
              cargo hakari manage-deps --dry-run  # all workspace crates depend on workspace_hack
              cargo hakari verify
            '';
